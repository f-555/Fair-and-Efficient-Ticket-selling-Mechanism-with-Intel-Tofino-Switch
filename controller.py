...
class TestDDoS(object):
    ...
    def runTest(self):
        ...
        # add entry--ternary
        #ticket = Table(self.target, gc, self.bfrt_info, "flow_num_counter","SwitchIngress")

        print('Port configuration finished')
...
#-----------------------------------------------------------------------------------------------------
    ...
    argparser.add_argument('--p4_name',
                           type=str,
                           default='n4r_hackthon',
                           help='P4 program name. Default: n4r_hackthon')
    ...
    logging.basicConfig(filename='n4r_hackthon.log',
                        filemode='w',
                        level=numeric_level,
                        format=logformat,
                        datefmt='%H:%M:%S')
